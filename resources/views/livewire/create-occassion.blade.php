<div>
    ...
    <div class="grid grid-cols-3 p-5">
        ...
        <div class="border border-gray-300">
            <input type="text" maxlength="30" class="w-full">
        </div>
        <div class="border border-gray-300">
            <input type="text" maxlength="2" class="w-full">
        </div>
        <div class="border border-gray-300 text-center">
            <button class="cursor-pointer border rounded px-1 bg-gray-200 hover:bg-gray-400 hover:text-white">submit</button>
        </div>
    </div>
</div>
